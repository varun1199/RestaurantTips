...
router.get('/', (req, res) => {
  ...
  if (wantsJson) {
    ...
    const apiDocs = {
      ...
      timestamp: new Date().toISOString(),
      documentation_url: '/api?format=html',
      status_url: '/status'
    };
...
<body>
  <header>
    <div class="container">
      ...
      <div>
        ...
        <a href="/api?format=json" class="button secondary">View as JSON</a>
      </div>
    </div>
  </header>
  ...
  "application": {
    ...
    "vercelEnvironment": "production",
    "maintenanceMode": false,
    "timestamp": "2025-03-25T03:06:55.733Z",
    "responseTime": "128ms"
  },
  "database": {
    "type": "PostgreSQL (Neon)",
  ...
  "version": "1.0.0"
    ...
    <div class="footer">
      ...
      <a href="/api?format=json" class="json-link">View API documentation as JSON</a>
    </div>
  </div>
</body>
</html>`;
      ...
      console.error('Error serving HTML docs:', error);
